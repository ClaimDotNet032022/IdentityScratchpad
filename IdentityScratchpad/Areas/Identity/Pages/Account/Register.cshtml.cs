...
namespace IdentityScratchpad.Areas.Identity.Pages.Account
{
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    _userManager.AddClaimAsync(user, new Claim("LuckyNumber", Input.LuckyNumber.ToString())).Wait();

                    if (Input.IsAdmin)
                    {
                        _userManager.AddClaimAsync(user, new Claim("Admin", true.ToString())).Wait();
                    }
